    ...
    return(
      <div className="row" >
        ...
        <div className="col-9 margin-top-2_5">
          <div className="row">
            <div className="col-5">
              <button className="width-100  btn btn_landing " onClick={()=>{this.props.ChangeURL("/admin/login")}} style={{fontSize:"14px"}}>Login</button>
            </div>

            <div className="col-5">
              <button onClick={()=>{this.props.ChangeURL("/admin/signup")}} className="width-100  btn signup_button_landing btn_landing black-background white"style={{fontSize:"14px"}}>Signup</button>
            </div>
